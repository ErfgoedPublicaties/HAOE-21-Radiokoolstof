...
<!--chapter:end:00_C14_wijzigingen.Rmd-->
...
```{r koolstofcyclus, fig.cap='Vereenvoudigde voorstelling van de koolstofcyclus. (&copy; KIK/IRPA, Brussel)', echo = FALSE, out.width='100%', fig.asp=.75, fig.align='center'}
...
```{r halfwaardetijd, fig.cap='Evolutie van het ^14^C-gehalte in de resten van een organisme, in functie van de tijd.', echo = FALSE, out.width='60%', fig.asp=.75, fig.align='center'}
...
```{r MICADAS, fig.cap='Opstelling van een MICADAS aan het KIK/IRPA te Brussel. (foto: &copy; KIK/IRPA, Brussel)', echo = FALSE, out.width='100%', fig.asp=.75, fig.align='center'}
...
<!--chapter:end:02_C14_principes.Rmd-->
...
```{r calcurves, fig.cap="Vergelijking van de huidige en voorgaande kalibratiecurves in de Romeinse periode.", echo = FALSE, out.width='80%', fig.asp=.75, fig.align='center'}

knitr::include_graphics("./figuren/calcurves.jpg")
...
```{r calcurves-res, fig.cap="Vergelijking van de resolutie van de huidige en voorgaande kalibratiecurves.", echo = FALSE, out.width='100%', fig.asp=.75, fig.align='center'}

knitr::include_graphics("./figuren/calcurves_res.jpg")
...
<!--chapter:end:03_C14_kalibratie.Rmd-->
...
<!--chapter:end:04_C14_onderzoeksvragen.Rmd-->
...
```{r bot, fig.cap="Selectie van archeologisch botmateriaal voor een ^14^C-datering.", echo = FALSE, out.width='100%', fig.asp=.75, fig.align='center'}

knitr::include_graphics("./figuren/figuur_20.jpg")
...
```{r tabelAMS, echo=FALSE, message=FALSE, warning=FALSE, results='asis'}
library(readxl)
df <- read_xlsx("./tabellen/Tabel_AMS.xlsx")
options(knitr.kable.NA = '')
knitr::kable(
     df, caption = "Optimaal gewicht van stalen voor radiokoolstofdatering via AMS."
) 
...
```{r registratie, fig.cap="Voorbeeld van een online registratieformulier voor te analyseren stalen (http://radiocarbon.kikirpa.be/)", echo = FALSE, out.width='80%', fig.asp=.75, fig.align='center'}

knitr::include_graphics("./figuren/figuur_21.png")
...
<!--chapter:end:05_C14_bemonsteren.Rmd-->
...
```{r rapport, fig.cap="Voorbeeld van een dateringsrapport. Hier worden enkel de conventionele radiokoolstofouderdom en de gekalibreerde dateringen gerapporteerd.", echo = FALSE, out.width='100%', fig.asp=.75, fig.align='center'}

knitr::include_graphics("./figuren/figuur_22.jpg")
...
<!--chapter:end:06_C14_rapporteren.Rmd-->
...
```{r Bayes, fig.cap="De stelling van Bayes, 'vertaald' naar het erfgoedonderzoek.", echo = FALSE, out.width='80%', fig.asp=.75, fig.align='center'}

knitr::include_graphics("./figuren/figuur_23.png")
...
```{r Rcombine, fig.cap="Fictief voorbeeld waarbij twee dateringen voorafgaand aan de kalibratie worden gecombineerd.", echo = FALSE, out.width='80%', fig.asp=.75, fig.align='center'}

knitr::include_graphics("./figuren/figuur_24.png")
...
```{r Difference, fig.cap="Waarschijnlijkheidsdistributie van het verschil tussen telkens twee radiokoolstofdateringen (A en B, C en D). Tussen de dateringen A en B is er statistisch gezien geen duidelijk verschil: ze kunnen ook overlappen (interval omvat 0 jaar en meer, met 95,4% probabiliteit). Tussen datering C en D is er een chronologisch verschil: datering C is tussen de 26 en 215 jaar ouder dan D, met 95,4% probabiliteit.", echo = FALSE, out.width='80%', fig.asp=.75, fig.align='center'}

knitr::include_graphics("./figuren/figuur_25.png")
...
```{r Sum, fig.cap="Voorbeeld van een probabiliteitssom van 69 radiokoolstofdateringen op stukjes houtskool uit houtskoolmeilers.", echo = FALSE, out.width='80%', fig.asp=.75, fig.align='center'}

knitr::include_graphics("./figuren/figuur_27.png")
...
```{r wiggle-matching, fig.cap="Wiggle-matching uitgevoerd op een plank van een waterputbekisting uit de late bronstijd (a). Vijf stalen waarop een radiokoolstofdatering werd uitgevoerd (b) worden in een wiskundig model aan elkaar verbonden door de tussenafstand, uitgedrukt in aantal jaarringen, in het model op te nemen (c). Het opgebouwde model laat toe om de veldatum van dit stuk hout veel preciezer te bepalen dan op basis van de individuele radiokoolstofdateringen mogelijk is.", echo = FALSE, out.width='80%', fig.asp=.75, fig.align='center'}

knitr::include_graphics("./figuren/figuur_28.png")
...
<!--chapter:end:07_C14_modelleren.Rmd-->

# Bronnen {#bronnen}

<div id="refs"></div>

<!--chapter:end:C14_bronnen.Rmd-->
...
knitr::include_graphics("./figuren/figuur_B_02_update.png")
...
knitr::include_graphics("./figuren/figuur_B_03_update.png")
...
knitr::include_graphics("./figuren/figuur_B_04_update.png")
...
knitr::include_graphics("./figuren/figuur_B_05_update.png")
...
knitr::include_graphics("./figuren/figuur_B_06_update.png")
...
knitr::include_graphics("./figuren/figuur_B_07_update.png")
...
```{r oxcal-09, fig.cap='Copy-paste de gegevens van de radiokoolstofdateringen rechtstreeks in OxCal.', echo = FALSE, out.width='40%', fig.asp=.75, fig.align='center'}
...
knitr::include_graphics("./figuren/figuur_B_11_update.png")
...
knitr::include_graphics("./figuren/figuur_B_12_update.png")
...
knitr::include_graphics("./figuren/figuur_B_15_update.png")
...
```{r oxcal-16, fig.cap='Modellering van radiokoolstofdateringen uit drie elkaar opvolgende fases, gedateerd met materiaal uit drie lagen in een stratigrafie', echo = FALSE, out.width='80%', fig.asp=.75, fig.align='center'}

knitr::include_graphics("./figuren/figuur_B_16_update.png")
...
knitr::include_graphics("./figuren/figuur_B_17_update.png")
...
knitr::include_graphics("./figuren/figuur_B_19_update.png")
...
```{r oxcal-20, fig.cap='Berekening van de periode die wordt overspannen door de radiokoolstofdateringen (Span) en de geschatte duur van de fase (Interval).', echo = FALSE, out.width='100%', fig.asp=.75, fig.align='center', fig.show='hold'}

knitr::include_graphics("./figuren/figuur_B_20_update_a.png")
knitr::include_graphics("./figuren/figuur_B_20_update_b.png")
knitr::include_graphics("./figuren/figuur_B_20_update_c.png")
...
knitr::include_graphics("./figuren/figuur_B_21_update.png")
...
```{r oxcal-22, fig.cap='Gemodelleerde datering van een individueel element uit het opgebouwde Bayesiaans model.', echo = FALSE, out.width='80%', fig.asp=.75, fig.align='center'}

knitr::include_graphics("./figuren/figuur_B_22_update.png")
