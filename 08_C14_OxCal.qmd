...
![](./figuren/figuur_B_01.jpg)

Inlogscherm voor OxCal op https://c14.arch.ox.ac.uk/login.
:::
...
Bij het opstarten van OxCal krijgen we het openingsscherm te zien dat meteen toelaat om een $\mathrm{^{14}C}$-datering te kalibreren (linksboven op @fig-oxcal-cal).

::: {#fig-oxcal-cal}

![](./figuren/figuur_B_02_update.png)

Openingsscherm van OxCal. Linksboven kan je een individuele radiokoolstofdatering invoeren en kalibreren.
:::
...
Door de knop `[Calibrate]` aan te klikken wordt de kalibratie uitgevoerd en het resultaat meteen in een grafiek voorgesteld (@fig-oxcal-calplot).


::: {#fig-oxcal-calplot}

![](./figuren/figuur_B_03_update.png)
:::


De vormgeving van deze grafiek kan je daarna nog aanpassen in het menu [Format] (@fig-oxcal-layout). Daar kan je op het tabblad Show kiezen welk betrouwbaarheidsinterval (68,2%, 95,4% en/of 99,7%) en wat voor variabelen (mean = gemiddelde, sigma = standaardafwijking, median = mediaan) je wil weergeven. Het bereik van de assen en de zoomfactor kan je eveneens aanpassen naar eigen voorkeur, via het tabblad Adjust of met de selectieknoppen `[Zoom]`, `[Centre]` en `[Span]` in de werkbalk boven de grafiek die je daarna kan aanpassen met de pijltjestoetsen op je klavier.

::: {#fig-oxcal-layout}

![](./figuren/figuur_B_04_update.png)

De lay-out van de grafieken kan via het menu [Format] worden aangepast
:::
...
Onder het invulmenu van het openingsscherm (@fig-oxcal-cal) zijn nog twee andere functies beschikbaar:
...
![](./figuren/figuur_B_07_update.png)
...
Een nog eenvoudiger alternatief start met het openen van een nieuw project in OxCal. In het Excel bestand kopieer je ondertussen de drie kolommen met de labocode, radiokoolstofouderdom en de standaardafwijking. Via het tabblad `[Tools > Import]` krijg je een venster te zien met drie kolommen: `Name`, `14C Date` en `Uncertainty` (@fig-oxcal-excel2). In dit venster plak je de gegevens die je uit Excel hebt gekopieerd. Met de knop `[ >> ]` worden deze dateringen dan omgezet en overgebracht in het venster met de programmeercode.

::: {#fig-oxcal-excel2}

![](./figuren/figuur_B_09.jpg)

Copy-paste de gegevens van de radiokoolstofdateringen rechtstreeks in OxCal.
:::


Welke methode er ook wordt gevolgd, door de aangemaakte programmeercode uit te voeren, bekomt men ̩̩n grafiek met alle radiokoolstofdateringen samen.
...
![](./figuren/figuur_B_11_update.png)

Programmacode voor het simuleren van een datering op materiaal uit 650 AD.
:::
...
![](./figuren/figuur_B_12_update.png)
...
![](./figuren/figuur_B_13_update_a.png){group="difference-gallery"}

![](./figuren/figuur_B_13_update_b.png){group="difference-gallery"}
...
![](./figuren/figuur_B_15_update.png)
...
![](./figuren/figuur_B_16_update.png)
...
![](./figuren/figuur_B_17_update.png)
...
![](./figuren/figuur_B_19_update.png)
...
![](./figuren/figuur_B_20_update_a.png){group="span-gallery"}

![](./figuren/figuur_B_20_update_b.png){group="span-gallery"} 

![](./figuren/figuur_B_20_update_c.png){group="span-gallery"}
...
:::{#fig-oxcal-output3}
![](./figuren/figuur_B_22_update.png)
