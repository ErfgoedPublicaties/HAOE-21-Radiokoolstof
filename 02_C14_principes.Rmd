...
```{r normaalverdeling, fig.cap='De normaalverdeling met karakteristieke parameters, *µ* = het gemiddelde en *s* = de standaardafwijking.', echo = FALSE, out.width='80%', fig.asp=.75, fig.align='center'}
